...
const clients: Client[] = [
  {
    ...
    summary:
      'Independent platform for government transparency. With over 30M records in our database and 400+ hours of research, we provide unprecedented access to California government operations, programs, and spending data',
    fullDescription:
...
export default function ClientCarousel() {
  ...
  return (
    <section
      id='clients'
      style={{ padding: '4px 0', backgroundColor: '#f9fafb' }}
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px' }}>
        ...
        >
          <CarouselContent
            style={{ display: 'flex', gap: '16px', padding: '0 16px' }}
          >
            {clients.map(client => (
              <CarouselItem
                key={client.name}
