        ...
        <section className="hero" style={{background: 'var(--ifm-background-surface-color)', color: 'var(--ifm-color-content)'}}>
          <div className="container">
            ...
            <p style={{textAlign: 'center', fontSize: '1.2rem', margin: 0}}>
              Watch recorded meetings, access notes, and stay updated on our collaboration efforts
            </p>
              ...
              <div className="col col--8 col--offset--2">
                <div className="card" style={{padding: '0', overflow: 'hidden'}}>
                  ...
                  <div style={{padding: '24px'}}>
                    ...
                    <p>Our inaugural meeting discussing the formation of the DOGE Network and plans for government transparency projects.</p>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col col--6">
                <div className="card">
                  <h3>📝 Meeting Notes</h3>
                  <p>Access detailed notes from our previous meetings including action items, decisions, and follow-up tasks.</p>
              ...
              <div className="col col--6">
                <div className="card">
                  ...
                  <p>Review upcoming meeting agendas and contribute topics for discussion in future sessions.</p>
                  <div style={{marginTop: '16px'}}>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col col--4">
                <div className="card">
                  <h4>December 2024</h4>
                  <p>Kickoff meeting discussing network formation and initial project ideas.</p>
              ...
              <div className="col col--4">
                <div className="card">
                  <h4>October 2024</h4>
                  <p>Initial discussions about government transparency collaboration.</p>
                ...
                <div className="card" style={{textAlign: 'center'}}>
                  <h2 style={{color: 'var(--ifm-color-primary)', marginBottom: '24px'}}>
                    Join Our Next Meeting
                      ...
                      Ready to contribute to government transparency? Join our next meeting and help shape the future of the DOGE Network.
                    </p>
                  <div>
